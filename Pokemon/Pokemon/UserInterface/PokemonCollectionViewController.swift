...
private let reuseIdentifier = "pokemanCell"
...
//        self.collectionView.register(CollectionViewCell.self, forCellWithReuseIdentifier: "pokemanCell")
